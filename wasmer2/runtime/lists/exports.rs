pub mod imports {
    ...
    impl std::fmt::Debug for UnalignedRecord {
        ...
        exports.insert(
            ...
            wasmer::Function::new_native_with_env(
                ...
                move |env: &std::sync::Arc<std::sync::Mutex<EnvWrapper<T>>>,
                    ...
                    let vec3 = t2_0;
                    let ptr3 = func_canonical_abi_realloc.call(0, 0, 1, (vec3.len() as i32) * 1)?;
                    let caller_memory =
                        unsafe { env.memory.get_ref().unwrap().data_unchecked_mut() };
        ...
        exports.insert(
            ...
            wasmer::Function::new_native_with_env(
                ...
                move |env: &std::sync::Arc<std::sync::Mutex<EnvWrapper<T>>>,
                    ...
                    let (t2_0, t2_1) = result;
                    let vec3 = t2_0;
                    let ptr3 = func_canonical_abi_realloc.call(0, 0, 2, (vec3.len() as i32) * 2)?;
                    let caller_memory =
                        unsafe { env.memory.get_ref().unwrap().data_unchecked_mut() };
                    caller_memory.store_many(ptr3, &vec3)?;
                    caller_memory
                    ...
                    caller_memory.store(arg4 + 0, wit_bindgen_wasmer::rt::as_i32(ptr3))?;
                    let vec4 = t2_1;
                    let ptr4 = func_canonical_abi_realloc.call(0, 0, 2, (vec4.len() as i32) * 2)?;
                    let caller_memory =
                        unsafe { env.memory.get_ref().unwrap().data_unchecked_mut() };
                    caller_memory.store_many(ptr4, &vec4)?;
                    caller_memory
        ...
        exports.insert(
            ...
            wasmer::Function::new_native_with_env(
                ...
                move |env: &std::sync::Arc<std::sync::Mutex<EnvWrapper<T>>>,
                    ...
                    caller_memory.store(arg4 + 0, wit_bindgen_wasmer::rt::as_i32(ptr3))?;
                    let vec4 = t2_1;
                    let ptr4 = func_canonical_abi_realloc.call(0, 0, 4, (vec4.len() as i32) * 4)?;
                    let caller_memory =
                        unsafe { env.memory.get_ref().unwrap().data_unchecked_mut() };
                    caller_memory.store_many(ptr4, &vec4)?;
                    caller_memory
        ...
        exports.insert(
            ...
            wasmer::Function::new_native_with_env(
                ...
                move |env: &std::sync::Arc<std::sync::Mutex<EnvWrapper<T>>>,
                    ...
                    let (t2_0, t2_1) = result;
                    let vec3 = t2_0;
                    let ptr3 = func_canonical_abi_realloc.call(0, 0, 8, (vec3.len() as i32) * 8)?;
                    let caller_memory =
                        unsafe { env.memory.get_ref().unwrap().data_unchecked_mut() };
                    caller_memory.store_many(ptr3, &vec3)?;
                    caller_memory
                    ...
                    caller_memory.store(arg4 + 0, wit_bindgen_wasmer::rt::as_i32(ptr3))?;
                    let vec4 = t2_1;
                    let ptr4 = func_canonical_abi_realloc.call(0, 0, 8, (vec4.len() as i32) * 8)?;
                    let caller_memory =
                        unsafe { env.memory.get_ref().unwrap().data_unchecked_mut() };
                    caller_memory.store_many(ptr4, &vec4)?;
                    caller_memory
        ...
        exports.insert(
            ...
            wasmer::Function::new_native_with_env(
                ...
                move |env: &std::sync::Arc<std::sync::Mutex<EnvWrapper<T>>>,
                    ...
                    let vec1 = result;
                    let ptr1 = func_canonical_abi_realloc.call(0, 0, 1, (vec1.len() as i32) * 1)?;
                    let caller_memory =
                        unsafe { env.memory.get_ref().unwrap().data_unchecked_mut() };
