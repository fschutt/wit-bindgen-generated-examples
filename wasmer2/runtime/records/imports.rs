pub mod exports {
    ...
    pub struct Exports {
        ...
        func_multiple_results: wasmer::NativeFunc<(), i32>,
        func_roundtrip_flags1: wasmer::NativeFunc<i32, i32>,
        func_roundtrip_flags2: wasmer::NativeFunc<i32, i32>,
        func_roundtrip_flags3: wasmer::NativeFunc<(i32, i32, i32, i32, i32), i32>,
        func_roundtrip_record1: wasmer::NativeFunc<(i32, i32), i32>,
        func_swap_tuple: wasmer::NativeFunc<(i32, i32), i32>,
        func_test_imports: wasmer::NativeFunc<(), ()>,
        func_tuple0: wasmer::NativeFunc<(), ()>,
        func_tuple1: wasmer::NativeFunc<i32, i32>,
    ...
    impl Exports {
        ...
        pub fn new(
            ...
            let func_multiple_results = instance
                .exports
                .get_native_function::<(), i32>("multiple-results")?;
            let func_roundtrip_flags1 = instance
                .exports
                .get_native_function::<i32, i32>("roundtrip-flags1")?;
            let func_roundtrip_flags2 = instance
                .exports
                .get_native_function::<i32, i32>("roundtrip-flags2")?;
            let func_roundtrip_flags3 = instance
                .exports
                .get_native_function::<(i32, i32, i32, i32, i32), i32>("roundtrip-flags3")?;
            let func_roundtrip_record1 = instance
                .exports
                .get_native_function::<(i32, i32), i32>("roundtrip-record1")?;
            let func_swap_tuple = instance
                .exports
                .get_native_function::<(i32, i32), i32>("swap-tuple")?;
            let func_test_imports = instance
                .exports
                .get_native_function::<(), ()>("test-imports")?;
            let func_tuple0 = instance.exports.get_native_function::<(), ()>("tuple0")?;
            let func_tuple1 = instance.exports.get_native_function::<i32, i32>("tuple1")?;
        ...
        pub fn multiple_results(&self) -> Result<(u8, u16), wasmer::RuntimeError> {
            let memory = &self.memory;
            let result0 = self.func_multiple_results.call()?;
            let load1 = unsafe { memory.data_unchecked_mut() }.load::<u8>(result0 + 0)?;
            let load2 = unsafe { memory.data_unchecked_mut() }.load::<u16>(result0 + 2)?;
            Ok((
                u8::try_from(i32::from(load1)).map_err(bad_int)?,
                u16::try_from(i32::from(load2)).map_err(bad_int)?,
            ))
        }
        pub fn swap_tuple(&self, a: (u8, u32)) -> Result<(u32, u8), wasmer::RuntimeError> {
            let memory = &self.memory;
            let (t0_0, t0_1) = a;
            ...
            let load3 = unsafe { memory.data_unchecked_mut() }.load::<u8>(result1 + 4)?;
            Ok((
                load2 as u32,
                u8::try_from(i32::from(load3)).map_err(bad_int)?,
            ))
        }
        pub fn roundtrip_flags1(&self, a: F1) -> Result<F1, wasmer::RuntimeError> {
            let flags0 = a;
            let result1 = self.func_roundtrip_flags1.call((flags0.bits >> 0) as i32)?;
            Ok(validate_flags(
                0 | ((result1 as u8) << 0),
                F1::all().bits(),
                "F1",
        ...
        pub fn roundtrip_flags2(&self, a: F2) -> Result<F2, wasmer::RuntimeError> {
            let flags0 = a;
            let result1 = self.func_roundtrip_flags2.call((flags0.bits >> 0) as i32)?;
            Ok(validate_flags(
                0 | ((result1 as u8) << 0),
                F2::all().bits(),
                "F2",
        ...
        pub fn roundtrip_flags3(
            ...
            let load5 = unsafe { memory.data_unchecked_mut() }.load::<u8>(result4 + 0)?;
            let load6 = unsafe { memory.data_unchecked_mut() }.load::<u16>(result4 + 2)?;
            let load7 = unsafe { memory.data_unchecked_mut() }.load::<i32>(result4 + 4)?;
            let load8 = unsafe { memory.data_unchecked_mut() }.load::<i32>(result4 + 8)?;
            let load9 = unsafe { memory.data_unchecked_mut() }.load::<i32>(result4 + 12)?;
            Ok((
                validate_flags(
        ...
        pub fn roundtrip_record1(&self, a: R1) -> Result<R1, wasmer::RuntimeError> {
            let memory = &self.memory;
            let R1 { a: a0, b: b0 } = a;
            let flags1 = b0;
            ...
            let load4 = unsafe { memory.data_unchecked_mut() }.load::<u8>(result2 + 1)?;
            Ok(R1 {
        ...
        pub fn tuple0(&self, a: ()) -> Result<(), wasmer::RuntimeError> {
            let () = a;
            self.func_tuple0.call()?;
            Ok(())
        }
        pub fn tuple1(&self, a: (u8,)) -> Result<(u8,), wasmer::RuntimeError> {
            let (t0_0,) = a;
            let result1 = self
                .func_tuple1
