pub mod many_arguments {
    ...
    impl<'a> std::fmt::Debug for BigStruct<'a> {
    ...
    impl wasmer::WasmerEnv for ManyArgumentsData {
    ...
    impl Clone for ManyArgumentsData {
        fn clone(&self) -> Self {
            Self::default()
        }
    }
    pub struct ManyArguments {
        state: std::sync::Arc<std::sync::Mutex<ManyArgumentsData>>,
        func_big_argument: wasmer::NativeFunc<i32, ()>,
        func_canonical_abi_realloc: wasmer::NativeFunc<(i32, i32, i32, i32), i32>,
        func_many_args: wasmer::NativeFunc<i32, ()>,
    ...
    impl ManyArguments {
        ...
        ) -> std::sync::Arc<std::sync::Mutex<ManyArgumentsData>> {
        ...
        pub fn new(
            ...
            let func_big_argument = instance
                .exports
                .get_native_function::<i32, ()>("big-argument")?;
            let func_canonical_abi_realloc = instance
                .exports
                .get_native_function::<(i32, i32, i32, i32), i32>("canonical_abi_realloc")?;
            let func_many_args = instance
                .exports
                .get_native_function::<i32, ()>("many-args")?;
        ...
        pub fn many_args(
            ...
            self.func_many_args.call(ptr0)?;
            Ok(())
        }
        pub fn big_argument(&self, x: BigStruct<'_>) -> Result<(), wasmer::RuntimeError> {
            let func_canonical_abi_realloc = &self.func_canonical_abi_realloc;
            let memory = &self.memory;
            let ptr0 = func_canonical_abi_realloc.call(0, 0, 4, 160)?;
            let BigStruct {
                a1: a11,
                a2: a21,
                a3: a31,
            ...
            let vec5 = a41;
            let ptr5 = func_canonical_abi_realloc.call(0, 0, 1, vec5.len() as i32)?;
            unsafe { memory.data_unchecked_mut() }.store_many(ptr5, vec5.as_bytes())?;
            unsafe { memory.data_unchecked_mut() }
                .store(ptr0 + 28, wit_bindgen_wasmer::rt::as_i32(vec5.len() as i32))?;
            unsafe { memory.data_unchecked_mut() }
                .store(ptr0 + 24, wit_bindgen_wasmer::rt::as_i32(ptr5))?;
            let vec6 = a51;
            let ptr6 = func_canonical_abi_realloc.call(0, 0, 1, vec6.len() as i32)?;
            unsafe { memory.data_unchecked_mut() }.store_many(ptr6, vec6.as_bytes())?;
            unsafe { memory.data_unchecked_mut() }
                .store(ptr0 + 36, wit_bindgen_wasmer::rt::as_i32(vec6.len() as i32))?;
            unsafe { memory.data_unchecked_mut() }
                .store(ptr0 + 32, wit_bindgen_wasmer::rt::as_i32(ptr6))?;
            let vec7 = a61;
            let ptr7 = func_canonical_abi_realloc.call(0, 0, 1, vec7.len() as i32)?;
            unsafe { memory.data_unchecked_mut() }.store_many(ptr7, vec7.as_bytes())?;
            unsafe { memory.data_unchecked_mut() }
                .store(ptr0 + 44, wit_bindgen_wasmer::rt::as_i32(vec7.len() as i32))?;
            unsafe { memory.data_unchecked_mut() }
                .store(ptr0 + 40, wit_bindgen_wasmer::rt::as_i32(ptr7))?;
            let vec8 = a71;
            let ptr8 = func_canonical_abi_realloc.call(0, 0, 1, vec8.len() as i32)?;
            unsafe { memory.data_unchecked_mut() }.store_many(ptr8, vec8.as_bytes())?;
            unsafe { memory.data_unchecked_mut() }
                .store(ptr0 + 52, wit_bindgen_wasmer::rt::as_i32(vec8.len() as i32))?;
            unsafe { memory.data_unchecked_mut() }
                .store(ptr0 + 48, wit_bindgen_wasmer::rt::as_i32(ptr8))?;
            let vec9 = a81;
            let ptr9 = func_canonical_abi_realloc.call(0, 0, 1, vec9.len() as i32)?;
            unsafe { memory.data_unchecked_mut() }.store_many(ptr9, vec9.as_bytes())?;
            unsafe { memory.data_unchecked_mut() }
                .store(ptr0 + 60, wit_bindgen_wasmer::rt::as_i32(vec9.len() as i32))?;
            unsafe { memory.data_unchecked_mut() }
                .store(ptr0 + 56, wit_bindgen_wasmer::rt::as_i32(ptr9))?;
            let vec10 = a91;
            let ptr10 = func_canonical_abi_realloc.call(0, 0, 1, vec10.len() as i32)?;
            unsafe { memory.data_unchecked_mut() }.store_many(ptr10, vec10.as_bytes())?;
            unsafe { memory.data_unchecked_mut() }.store(
                ptr0 + 68,
            ...
            let vec12 = a111;
            let ptr12 = func_canonical_abi_realloc.call(0, 0, 1, vec12.len() as i32)?;
            unsafe { memory.data_unchecked_mut() }.store_many(ptr12, vec12.as_bytes())?;
            unsafe { memory.data_unchecked_mut() }.store(
                ptr0 + 84,
            ...
            let vec13 = a121;
            let ptr13 = func_canonical_abi_realloc.call(0, 0, 1, vec13.len() as i32)?;
            unsafe { memory.data_unchecked_mut() }.store_many(ptr13, vec13.as_bytes())?;
            unsafe { memory.data_unchecked_mut() }.store(
                ptr0 + 92,
            ...
            let vec14 = a131;
            let ptr14 = func_canonical_abi_realloc.call(0, 0, 1, vec14.len() as i32)?;
            unsafe { memory.data_unchecked_mut() }.store_many(ptr14, vec14.as_bytes())?;
            unsafe { memory.data_unchecked_mut() }.store(
                ptr0 + 100,
            ...
            let vec15 = a141;
            let ptr15 = func_canonical_abi_realloc.call(0, 0, 1, vec15.len() as i32)?;
            unsafe { memory.data_unchecked_mut() }.store_many(ptr15, vec15.as_bytes())?;
            unsafe { memory.data_unchecked_mut() }.store(
                ptr0 + 108,
            ...
            let vec16 = a151;
            let ptr16 = func_canonical_abi_realloc.call(0, 0, 1, vec16.len() as i32)?;
            unsafe { memory.data_unchecked_mut() }.store_many(ptr16, vec16.as_bytes())?;
            unsafe { memory.data_unchecked_mut() }.store(
                ptr0 + 116,
            ...
            let vec17 = a161;
            let ptr17 = func_canonical_abi_realloc.call(0, 0, 1, vec17.len() as i32)?;
            unsafe { memory.data_unchecked_mut() }.store_many(ptr17, vec17.as_bytes())?;
            unsafe { memory.data_unchecked_mut() }.store(
                ptr0 + 124,
            ...
            let vec18 = a171;
            let ptr18 = func_canonical_abi_realloc.call(0, 0, 1, vec18.len() as i32)?;
            unsafe { memory.data_unchecked_mut() }.store_many(ptr18, vec18.as_bytes())?;
            unsafe { memory.data_unchecked_mut() }.store(
                ptr0 + 132,
            ...
            let vec19 = a181;
            let ptr19 = func_canonical_abi_realloc.call(0, 0, 1, vec19.len() as i32)?;
            unsafe { memory.data_unchecked_mut() }.store_many(ptr19, vec19.as_bytes())?;
            unsafe { memory.data_unchecked_mut() }.store(
                ptr0 + 140,
            ...
            let vec20 = a191;
            let ptr20 = func_canonical_abi_realloc.call(0, 0, 1, vec20.len() as i32)?;
            unsafe { memory.data_unchecked_mut() }.store_many(ptr20, vec20.as_bytes())?;
            unsafe { memory.data_unchecked_mut() }.store(
                ptr0 + 148,
            ...
            let vec21 = a201;
            let ptr21 = func_canonical_abi_realloc.call(0, 0, 1, vec21.len() as i32)?;
            unsafe { memory.data_unchecked_mut() }.store_many(ptr21, vec21.as_bytes())?;
            unsafe { memory.data_unchecked_mut() }.store(
                ptr0 + 156,
            ...
            self.func_big_argument.call(ptr0)?;
            Ok(())
        }
    }
