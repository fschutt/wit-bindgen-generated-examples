pub mod lists {
    ...
    pub trait Lists: Sized + wasmer::WasmerEnv + 'static {
        ...
        T: Lists,
    {
        ...
        impl<T: Lists> wasmer::WasmerEnv for EnvWrapper<T> {
        ...
        exports.insert(
            ...
            wasmer::Function::new_native_with_env(
                ...
                move |env: &std::sync::Arc<std::sync::Mutex<EnvWrapper<T>>>,
                    ...
                    let vec1 = result;
                    let ptr1 =
                        func_canonical_abi_realloc.call(0, 0, 8, (vec1.len() as i32) * 16)?;
                    let caller_memory =
                        unsafe { env.memory.get_ref().unwrap().data_unchecked_mut() };
        ...
        exports.insert(
            ...
            wasmer::Function::new_native_with_env(
                ...
                move |env: &std::sync::Arc<std::sync::Mutex<EnvWrapper<T>>>,
                    ...
                    let result7 = func_canonical_abi_realloc.call(0, 0, 4, len7 * 12)?;
                ...
                move |env: &std::sync::Arc<std::sync::Mutex<EnvWrapper<T>>>,
                    ...
                    for (i, e) in vec5.into_iter().enumerate() {
                        let base = result5 + (i as i32) * 8;
                        {
                            let vec4 = e;
                            let ptr4 =
                                func_canonical_abi_realloc.call(0, 0, 1, vec4.len() as i32)?;
                            let caller_memory =
                                unsafe { env.memory.get_ref().unwrap().data_unchecked_mut() };
        ...
        exports.insert(
            ...
            wasmer::Function::new_native_with_env(
                ...
                move |env: &std::sync::Arc<std::sync::Mutex<EnvWrapper<T>>>,
                    ...
                    let result34 = func_canonical_abi_realloc.call(0, 0, 8, len34 * 48)?;
                    for (i, e) in vec34.into_iter().enumerate() {
                        let base = result34 + (i as i32) * 48;
                        {
                            ...
                            let vec32 = b31;
                            let ptr32 =
                                func_canonical_abi_realloc.call(0, 0, 1, vec32.len() as i32)?;
                            let caller_memory =
                                unsafe { env.memory.get_ref().unwrap().data_unchecked_mut() };
        ...
        exports.insert(
            ...
            wasmer::Function::new_native_with_env(
                ...
                move |env: &std::sync::Arc<std::sync::Mutex<EnvWrapper<T>>>,
                    ...
                    let result20 = func_canonical_abi_realloc.call(0, 0, 8, len20 * 96)?;
                    for (i, e) in vec20.into_iter().enumerate() {
                        let base = result20 + (i as i32) * 96;
                        {
                            ...
                            let vec12 = x11;
                            let ptr12 =
                                func_canonical_abi_realloc.call(0, 0, 1, vec12.len() as i32)?;
                            let caller_memory =
                                unsafe { env.memory.get_ref().unwrap().data_unchecked_mut() };
                            ...
                            let vec14 = b13;
                            let ptr14 =
                                func_canonical_abi_realloc.call(0, 0, 1, vec14.len() as i32)?;
                            let caller_memory =
                                unsafe { env.memory.get_ref().unwrap().data_unchecked_mut() };
                            ...
                            let result19 = func_canonical_abi_realloc.call(0, 0, 8, len19 * 48)?;
        ...
        exports.insert(
            ...
            wasmer::Function::new_native_with_env(
                ...
                move |env: &std::sync::Arc<std::sync::Mutex<EnvWrapper<T>>>,
                    ...
                    let result15 = func_canonical_abi_realloc.call(0, 0, 4, len15 * 12)?;
        ...
        exports.insert(
            ...
            wasmer::Function::new_native_with_env(
                ...
                move |env: &std::sync::Arc<std::sync::Mutex<EnvWrapper<T>>>,
                    ...
                    let result17 = func_canonical_abi_realloc.call(0, 0, 8, len17 * 64)?;
                    for (i, e) in vec17.into_iter().enumerate() {
                        let base = result17 + (i as i32) * 64;
                        {
                            ...
                            let vec16 = t15_0;
                            let ptr16 =
                                func_canonical_abi_realloc.call(0, 0, 1, vec16.len() as i32)?;
                            let caller_memory =
                                unsafe { env.memory.get_ref().unwrap().data_unchecked_mut() };
        ...
        imports.register("lists", exports);
    }
